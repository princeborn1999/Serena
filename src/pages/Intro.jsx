        ...
        <div className="flex justify-center">
            <div className="px-40 py-10 w-4/5">
                <section id="intro">
                    ...
                    <div className="p-2">
                        <p>Empower your projects by the power of the web to control your Arduino. This dynamic integration </p>
                        <p>breathes life into your creations, it offers a unique and transformative  experience.</p>
                    </div>
                ...
                <section id="application">
                    ...
                    <div className="p-2">
                        <p>Enhancing the realism of video games like 'Zombie' 'Racing' or 
                           'Adventure'titles through Virtual Reality (VR) is an exciting concept.</p>
                        <p>VR indeed offers a heightened sense of immersion However, 
                           the current VR experience primarily focuses on visual engagement,
                           and there's an opportunity to enhance it further by engaging
                           more senses and environmental cues.</p>
                    </div>
                </section>
